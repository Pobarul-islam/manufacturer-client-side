...
const Order = ({ product, show, setShow }) => {
  ...
  return (
    <div
      className={`${
        show ? 'block' : 'hidden'
      } absolute product-order-page top-20 right-0 z-10 w-full`}
    >
          ...
          <div className="card relative w-full max-w-md shadow-2xl bg-base-100">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="card-body ">
                ...
                <label className="label">
                  <span className="label-text">
                    ...
                    <p className="font-bold text-neutral">
                      Min Order : {product.MinimumOrder} , Max Order{' '}
                      {product.Available}
                    </p>
                  </span>
                </label>
              ...
              <div className="form-control mt-5">
                ...
                >{`${loading ? 'Confirming....' : 'Submit Order'}`}</button>
              </div>
            </form>
          </div>
        </div>
